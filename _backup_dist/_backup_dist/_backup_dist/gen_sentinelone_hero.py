#!/usr/bin/env python3
"""Generate SentinelOne cybersecurity hero image via FAL flux/schnell, save + upload to R2."""
...
PROMPT = (
    ...
    "with multiple monitoring screens displaying threat detection dashboards. "
    "Realistic photo, shallow depth of field, professional lighting, dark moody atmosphere."
)
