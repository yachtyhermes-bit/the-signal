#!/usr/bin/env python3
"""Generate a photo-realistic hero image for 'anet-ai-networking-backbone-2026' using FAL flux/schnell."""

import os
import sys
import requests

SLUG = "anet-ai-networking-backbone-2026"
W, H = 1200, 675
...
PROMPT = (
    "Professional stock photograph of a modern data center server room with rows of "
    "network switches and blinking LEDs, tall server racks stretching down a long aisle, "
    "cable management trays overhead, dark cool atmosphere with blue ambient lighting. "
    "Realistic photo, shallow depth of field, professional lighting, editorial documentary "
    "photography. "
