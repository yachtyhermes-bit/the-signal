...
(function() {
  ...
  function loadLeaderboard(period) {
    ...
    fetch(API_BASE + '?leaderboard=' + periodParam)
      .then(function(r) { return r.json(); })
      .then(function(data) {
  ...
  function renderLeaderboard(data, container, period) {
    ...
    var html = '<div class="hive-lb-header">' +
      ...
      '</div>' +
      '<div class="hive-lb-table-wrap"><table class="hive-lb-table">' +
  ...
  function loadRules() {
    ...
    var html =
      ...
      '<p class="hive-rules-text">You can only trade stocks in The Signal\'s coverage universe — <strong>53 tickers</strong> across six sectors:</p>' +
      '<ul class="hive-rules-list">' +
      ...
      '<li><span class="hive-rules-sector" style="color:#fbbf24">Defense</span> — LMT, RTX, NOC, GD, LHX, KTOS, AVAV, PL, AXON, GE, PLTR</li>' +
