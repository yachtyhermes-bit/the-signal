#!/usr/bin/env python3
"""Generate a Datadog (DDOG) hero image using FAL flux/schnell.

Theme: AI observability moat — Datadog's AI-powered monitoring platform.
MANDATORY STYLE: Photo-realistic only — real data center / server room photograph.
...
SLUG = "ddog-ai-observability-moat-2026"
W, H = 1200, 630
OUTPUTS = [
...
PROMPT = (
    ...
    "with blinking lights, rows of server racks. Realistic photo, "
    "shallow depth of field, professional lighting, high contrast. "
    "Cool blue LED status lights on server hardware, clean corporate data center environment. "
