#!/usr/bin/env python3
"""Generate an HWM (Howmet Aerospace) hero image using FAL flux/schnell."""

import os
import sys
import requests

SLUG = "hwm-engine-tollbooth-2026"
W, H = 1200, 675
OUTPUTS = [
...
PROMPT = (
    "Professional stock photograph of a jet engine turbine blade manufacturing facility. "
    "Close-up of precision-cast single crystal turbine blades with complex cooling channels. "
    "Industrial aerospace setting with engineers inspecting components. Realistic photo, "
    "shallow depth of field, professional lighting, metallic surfaces gleaming under factory lights. "
    "High-end manufacturing, clean industrial environment. "
