#!/usr/bin/env python3
"""Generate a Fortinet (FTNT) hero image using FAL flux/schnell.

Theme: Cybersecurity operations center — the OpenAI rogue agent incident and AI-powered cyberattacks.
"""
...
SLUG = "ftnt-openai-rogue-agent-cybersecurity-2026"
W, H = 1200, 675
OUTPUTS = [
...
PROMPT = (
    "Professional stock photograph of a modern network security operations center. "
    "Multiple monitors displaying threat detection dashboards, a server rack with blinking lights in the background. "
    "Clean professional lighting, shallow depth of field, commercial photography style, realistic corporate environment. "
    "No text overlays, no logos, no branding on screens. "
    "Photographed with a full-frame DSLR, sharp focus, high-end commercial grade image."
)
