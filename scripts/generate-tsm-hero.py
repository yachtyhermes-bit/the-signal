#!/usr/bin/env python3
"""Generate a hero image for 'tsm-august-sales-ai-demand-2026' using FAL flux/schnell.

Photo-realistic only: semiconductor cleanroom with workers in bunny suits
inspecting silicon wafers. No abstract/digital/neon/glowing/geometric art.
"""
...
SLUG = "tsm-august-sales-ai-demand-2026"
W, H = 1200, 675
...
PROMPT = (
    ...
    "Two technicians in full white bunny suits with hoods and face masks are inspecting "
    "silicon wafers held in a wafer carrier, standing beside advanced wafer processing equipment. "
    "Rows of chip manufacturing machines receding into the background, warm yellow sodium "
    "photolithography lighting mixed with soft white overhead cleanroom lighting, "
    "highly reflective epoxy floor, glass partition walls. "
    "Photo-realistic, shallow depth of field, professional industrial photography, "
    "sharp focus on the wafers, 4K, shot on a full-frame DSLR. "
