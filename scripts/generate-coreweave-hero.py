#!/usr/bin/env python3
"""Generate a CoreWeave hero image using FAL flux/schnell."""
import os
import sys
import requests

OUTPUT = "/home/chino/thesignal/public/img/articles/coreweave-ai-factory-moat-2026.jpg"
SLUG = "coreweave-ai-factory-moat-2026"
W, H = 1200, 675

PROMPT = (
    "Professional stock photograph of a modern AI data center with rows of GPU servers, "
    "realistic photo, shallow depth of field, professional lighting, cool blue tones, "
    "no text overlays, no branding text, no logos. Ultra-realistic, 8K resolution, "
