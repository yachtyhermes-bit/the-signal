#!/usr/bin/env python3
"""Generate a Microsoft (MSFT) Azure hero image using FAL flux/schnell."""
import os
import sys
import requests

OUTPUT = "/home/chino/thesignal/public/img/articles/msft-azure-100b-2026.jpg"
SLUG = "msft-azure-100b-2026"
W, H = 1200, 675

PROMPT = (
    "Professional stock photograph of a modern Microsoft Azure cloud data center "
    "server room with blue LED lighting. Long rows of tall server racks with "
    "blinking status LEDs, neatly organized network cables, cool blue ambient "
    "lighting, polished floor reflections, enterprise server room atmosphere. "
    "Realistic photo, shallow depth of field, professional lighting, 8K resolution. "
