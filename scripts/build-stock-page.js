...
function buildStockPage(symbol) {
  ...
  // Edge rating — our own assessment of the sources we score (generated by generate-moat.py).
// Not derived from, affiliated with, or endorsed by Morningstar, Inc.
  ...
  const moatLabel = moatData.rating === 'Wide' ? '🛡️ Strong Edge' : (moatData.rating === 'Narrow' ? '🛡️ Defensible Edge' : '⚠️ No Edge');
      ...
      <section class="stock-section signal-report-section">
        ...
        <div class="signal-report-grid">
          ...
          <div class="signal-rating-col">
            <div class="signal-rating-label">Edge Rating</div>
