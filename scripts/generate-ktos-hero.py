#!/usr/bin/env python3
"""Generate a Kratos Defense (KTOS) hero image using FAL flux/schnell.

Theme: Military drones, Valkyrie XQ-58, attritable mass autonomy, autonomous systems.
"""
...
SLUG = "ktos-attritable-mass-autonomy-2026"
W, H = 1200, 675
OUTPUTS = [
...
PROMPT = (
    "Professional stock photograph of a stealth military drone on a runway at dawn. "
    "Realistic photo, shallow depth of field, professional lighting, photorealistic. "
    "A single unmanned combat aerial vehicle with angular stealth design, parked on a tarmac "
    "with maintenance crew in the background. Soft morning light, realistic sky, "
    "commercial photography style, full-frame DSLR quality. "
    "No text overlays, no logos, no digital art, no neon, no glowing lines, no abstract graphics."
)
