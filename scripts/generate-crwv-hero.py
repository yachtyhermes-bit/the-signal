#!/usr/bin/env python3
"""Generate a hero image for 'crwv-q2-2026-earnings-ai-cloud-inflection' using FAL flux/schnell."""
...
PROMPT = (
    "Professional stock photograph of a modern AI cloud data center, rows of tall GPU server racks "
    "with subtle blue accent lighting, clean raised-floor aisle with cool air vent tiles, "
    "shallow depth of field with a foreground server rack in sharp focus and a long aisle receding into the background, "
    "professional commercial lighting, shot on a full-frame DSLR, wide-angle, "
