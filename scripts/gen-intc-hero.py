#!/usr/bin/env python3
"""Generate a hero image for 'intc-foundry-gamble-national-champion-2026' using FAL flux/schnell."""
...
PROMPT = (
    "Professional stock photograph of a massive state-of-the-art semiconductor fabrication facility. "
    "Vast cleanroom interior with rows of advanced lithography and wafer processing equipment, "
    "illuminated by cool blue and warm amber LED lighting. Yellow-lit photolithography bays receding into the distance. "
    "Technicians in full white cleanroom bunny suits working at cutting-edge chip manufacturing tools. "
    "Highly reflective polished floors, industrial ceiling with utility conduits, glass walls. "
    "Dark moody atmosphere with dramatic cleanroom glow lighting. "
    "Photo-realistic, shallow depth of field, professional industrial lighting, 8K resolution. "
    "No text overlays, no logos, no branding. Intel-style blue corporate colors subtly present. "
    "Shot with full-frame DSLR, cinematic grading, documentary style. "
    "Conveys massive scale of advanced semiconductor manufacturing — a foundry at industrial scale."
)
