#!/usr/bin/env python3
"""Generate a hero image for 'nbis-ai-gpu-cloud-sovereign-moat-2026' using FAL flux/schnell."""

import os
import sys
import requests

SLUG = "nbis-ai-gpu-cloud-sovereign-moat-2026"
W, H = 1200, 675
...
PROMPT = (
    "Professional stock photograph of a modern AI data center with rows of GPU server racks. "
    "Tall black server cabinets with blue and teal LED accent lighting on the front panels and status indicators. "
    "Clean raised-floor data center environment with overhead cable management trays. "
    "Cool air vent tiles visible on the floor. Shallow depth of field with the foreground server in sharp focus "
    "and a long aisle of server racks fading into the background. "
    "Professional lighting with subtle cool blue ambient light from the servers contrasting with warm overhead work lights. "
    "Photo-realistic, shot on full-frame DSLR with a wide-angle lens, commercial photography quality. "
    "No text overlays, no logos, no branding, no abstract art, no digital art, no neon/synthwave, no glowing lines, no geometric patterns."
)
