#!/usr/bin/env python3
"""Generate a photo-realistic hero image for 'asts-direct-to-cell-moat-2026' using FAL flux/schnell."""

import os
import sys
import requests

SLUG = "asts-direct-to-cell-moat-2026"
W, H = 1200, 675
...
PROMPT = (
    "Professional stock photograph of a spacecraft integration cleanroom at a satellite "
    "manufacturing facility. Aerospace engineers in white cleanroom suits, hairnets and "
    "face masks assembling a massive flat blue phased-array antenna panel for a "
    "direct-to-cell communications satellite, the huge antenna array mounted upright on "
    "a precision assembly fixture, high-bay facility with overhead crane, gantry tooling "
    "and bright soft white lighting. "
    "Realistic photo, shallow depth of field focused on the antenna array and engineers, "
    "background softly blurred, professional lighting, editorial documentary photography. "
...
def main():
    ...
    result_code = os.system("cd /home/chino/thesignal && python3 scripts/r2_upload.py hero " + SLUG)
    if result_code != 0:
