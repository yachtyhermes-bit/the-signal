#!/usr/bin/env python3
"""Generate a hero image for 'asts-bluebird-delays-commercial-2026' using FAL flux/schnell."""
...
PROMPT = (
    "Professional stock photograph of a communications satellite in orbit above Earth, "
    "solar panels extended, transmitting cellular signal beams to the planet below. "
    "Realistic photo, shallow depth of field, professional lighting, NASA-style satellite photography. "
    "No text, no labels, no markings."
)
