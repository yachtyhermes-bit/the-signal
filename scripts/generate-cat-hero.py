#!/usr/bin/env python3
"""Generate a Caterpillar (CAT) hero image using FAL flux/schnell.

Theme: Heavy construction / earthmoving equipment on a massive infrastructure
site (data center / energy buildout), photo-realistic stock photography.
"""
...
SLUG = "cat-ai-power-record-backlog-2026"
W, H = 1200, 675
OUTPUTS = [
...
PROMPT = (
    "Professional stock photograph of a fleet of large yellow bulldozers and "
    "excavators working on a massive construction site at golden hour. Heavy "
    "earthmoving equipment carving out a vast foundation for new energy "
    "infrastructure, dust hanging in the warm air, tower cranes and power "
    "transmission lines in the background, a few construction workers in hard "
    "hats for scale. Realistic photo, shallow depth of field, professional "
    "lighting, photojournalism style, full-frame DSLR quality. "
    "No text overlays, no logos, no digital art, no neon, no glowing lines, "
    "no abstract graphics, no geometric patterns."
)
