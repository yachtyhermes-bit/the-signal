#!/usr/bin/env python3
"""Generate a Vistra Corp (VST) hero image using FAL flux/schnell."""

import os
import sys
import requests

SLUG = "vst-ai-power-nuclear-data-center-2026"
W, H = 1200, 675
OUTPUTS = [
...
PROMPT = (
    "Professional stock photograph of a modern nuclear power plant with massive cooling towers "
    "emitting white steam against a bright blue sky. In the foreground, high-voltage transmission "
    "lines and electrical substation infrastructure connect the plant to the grid. "
    "A sleek modern data center building is visible in the distance, representing AI industry demand "
    "for clean baseload nuclear power. Green grass and rural landscape surround the facility. "
    "Photo-realistic, shallow depth of field, professional lighting, corporate commercial photography, "
    "8K resolution, sharp focus, cinematic color grading. "
...
def main():
    ...
    # Set FAL_KEY from video_output file
