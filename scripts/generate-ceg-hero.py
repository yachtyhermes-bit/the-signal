#!/usr/bin/env python3
"""Generate a photo-realistic hero image for 'ceg-earnings-beat-raise-fcf-inflection-2026' using FAL flux/schnell."""

import os
import sys
import requests

SLUG = "ceg-earnings-beat-raise-fcf-inflection-2026"
W, H = 1200, 675
...
PROMPT = (
    "Professional stock photograph of a nuclear power plant at golden hour, a "
    "massive hyperbolic concrete cooling tower with a tall plume of white steam "
    "rising into a soft blue sky, low sun glinting off the industrial steel and "
    "concrete structures, electric transmission towers and power lines in the "
    "foreground, rolling green landscape in the background. "
    "Realistic photo, shallow depth of field focused on the cooling tower, "
    "background softly blurred, professional lighting, editorial documentary "
    "photography. "
