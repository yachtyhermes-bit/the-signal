#!/usr/bin/env python3
"""Generate a Huntington Ingalls (HII) hero image using FAL flux/schnell.

Theme: Nuclear-powered aircraft carrier under construction at Newport News Shipbuilding,
industrial shipbuilding scene. Photo-realistic only.
"""
...
SLUG = "hii-q2-2026-earnings-nuclear-navy-backlog"
W, H = 1200, 675
OUTPUTS = [
...
PROMPT = (
    "Professional stock photograph of a massive nuclear-powered aircraft carrier under "
    "construction at a large American shipyard. Gigantic gray steel hull in a dry dock, "
    "towering gantry cranes overhead, shipyard workers on scaffolding for scale, industrial "
    "haze in the background. Overcast maritime light, realistic photo, shallow depth of "
    "field, professional lighting, photojournalism style, full-frame DSLR quality. "
    "No text overlays, no logos, no digital art, no neon, no glowing lines, no abstract "
    "graphics, no geometric patterns."
)
